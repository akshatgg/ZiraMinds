...
export default function KeyFeatures() {
  return (
    <section className='bg-gradient-to-r from-[#200A18] to-[#091F21] text-white text-center py-16 px-5 h-auto'>
    ...
    <div className="flex min-h-screen items-center justify-center md:mt-[-15vh]">
      <div className="grid grid-cols-1 md:gap-[13vh] md:grid-cols-3">
          ...
          <div className="group relative cursor-pointer flex items-center justify-center overflow-hidden transition-shadow hover:shadow-xl focus-within:shadow-xl hover:shadow-black/30 focus-within:shadow-black/30">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#220A12] group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70 focus-within:from-black/70 focus-within:via-black/60 focus-within:to-black/70">
            </div>
          ...
          <div className="group relative cursor-pointer flex items-center justify-center overflow-hidden transition-shadow hover:shadow-xl focus-within:shadow-xl hover:shadow-black/30 focus-within:shadow-black/30">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#191119] group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70 focus-within:from-black/70 focus-within:via-black/60 focus-within:to-black/70">
            </div>
            <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0 focus-within:translate-y-0">
          ...
          <div className="group relative cursor-pointer flex items-center justify-center overflow-hidden transition-shadow hover:shadow-xl focus-within:shadow-xl hover:shadow-black/30 focus-within:shadow-black/30">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#0C1A20] group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70 focus-within:from-black/70 focus-within:via-black/60 focus-within:to-black/70">
            </div>
            <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0 focus-within:translate-y-0">
